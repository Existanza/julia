...
$(LLVM_BUILDDIR_withtype)/build-compiled: $(LLVM_BUILDDIR_withtype)/CMakeCache.txt | $(llvm_python_workaround)
...
ifeq ($(OS),$(BUILD_OS))
	...
	echo 1 > $@
$(build_prefix)/manifest/llvm: $(LLVM_BUILDDIR_withtype)/build-compiled | $(llvm_python_workaround) $(build_prefix)/manifest
ifeq ($(LLVM_USE_CMAKE),1)
CMAKE_INSTALL_LLVM = \
